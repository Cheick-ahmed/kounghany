...
@section('content')
    <header class="mt-20">
        <div class="">
            <img class="bg-cover object-cover w-full" src="{{ asset('images/ato.jpg') }}" alt="" style="height: 50vh">
        </div>
    </header>
    <div class="px-4 md:px-0 md:max-w-5xl md:mx-auto my-10">
        <h4 class="text-4xl md:text-5xl italic mb-6">Nos réalisations</h4>
        @for($i = 0; $i < 3; $i++)
            @include('partials.realisation')
        @endfor
        <div class="flex justify-center mt-12">
            <nav class="relative z-0 inline-flex shadow-sm">
                ...
                <a href="#" class="hidden md:inline-flex -ml-px relative items-center px-4 py-2 border border-gray-300 bg-white text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">8</a>
                <a href="#" class="-ml-px relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">9</a>
