...
@section('content')
    <div class="px-4 md:px-0 md:max-w-5xl md:mx-auto my-12">
        <header class="flex items-center justify-between md:min-h-screen mt-32 md:mt-0 mb-12 md:mb-0">
            <div class="w-full md:w-8/12 text-black">
                <h3 class="text-4xl text-black md:text-5xl italic">Kounghany Nafa</h3>
                <h3 class="text-3xl text-green-600 md:text-4xl italic">Charity association</h3>
                ...
                <a href="#" class="inline-block font-normal tracking-widest text-sm py-2 lg:py-3 mb-2 lg:mb-0 px-2 lg:px-10 hover:bg-gray-700 lg:hover:bg-green-800 bg-green-600 rounded-full tansition-all duration-500 mr-2">En savoir plus</a>
                <a href="#" class="inline-block font-normal tracking-widest text-sm py-2 lg:py-3 mb-2 lg:mb-0 px-2 lg:px-12 hover:bg-gray-700 lg:hover:bg-orange-800 bg-orange-600 rounded-full tansition-all duration-500">Dons</a>
            </div>
            <div class="hidden md:w-4/12 md:border md:border-red-700 md:h-2"></div>
        </header>
        @include('partials.events.cause')
        <section class="mt-12 md:my-20">
