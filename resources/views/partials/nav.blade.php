<nav x-data="{ open: false }" class="bg-nafa-dark shadow-lg mb-20 fixed top-0 py-3 w-full z-50 top-0 transition-all duration-700">
    ...
    <div x-description="Mobile menu, toggle classes based on menu state." x-state:on="Menu open" x-state:off="Menu closed" :class="{ 'block': open, 'hidden': !open }" class="sm:hidden hidden">
        <div class="px-2 pt-2 pb-3">
            <a href="{{ route('realisations.index') }}" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Réalisations</a>
