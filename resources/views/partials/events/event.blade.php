        ...
        <div class="p-6 rounded shadow text-black mb-4 bg-white grid lg:grid-cols-3 gap-4 shadow">
            ...
            <div class="col-span-2 text-gray-900 font-semibold">
                ...
                <div class="mt-3 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
                    <div class="mt-3 flex items-center text-sm font-bold leading-5 text-gray-800 sm:mr-6">
                        <svg class="flex-shrink-0 mr-1 h-5 w-5 text-gray-800" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
                        </svg>
                        25 mars 2020
                    </div>
                    <div class="mt-3 flex items-center text-sm font-bold leading-5 text-gray-800">
                        <svg class="flex-shrink-0 mr-1 h-5 w-5 text-gray-800" fill="currentColor" viewBox="0 0 20 20">
